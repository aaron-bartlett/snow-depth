...
model = GRUForecaster(input_features, nhid, output_features, sequence_len, n_deep_layers=n_dnn_layers, use_cuda=USE_CUDA).to(device)
...
date_features = torch.tensor(date_features, dtype=torch.float32).unsqueeze(0)
